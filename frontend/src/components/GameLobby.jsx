    ...
    return (
        <div className="w-full max-w-md mx-auto bg-gray-800 bg-opacity-70 rounded-xl shadow-lg p-6 text-white animate-fade-in">
            ...
            <div className="bg-gray-700 bg-opacity-50 rounded-lg p-4 my-3 transition-transform transform hover:scale-105">
                ...
                <p className="text-sm text-gray-300 mt-1 mb-3">Practice and play just for fun.</p>
                <button 
            ...
            {events.map(event => (
                <div key={event.id} className="bg-gray-700 bg-opacity-50 rounded-lg p-4 my-3 transition-transform transform hover:scale-105">
                    <h2 className="text-xl font-bold text-yellow-400">{event.name}</h2>
                    <p className="text-sm text-gray-300 mt-1 mb-3">{event.description}</p>
                    <button 
